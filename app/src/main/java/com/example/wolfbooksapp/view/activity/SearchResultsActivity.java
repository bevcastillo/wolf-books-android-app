...
import com.example.wolfbooksapp.adapters.SearchResultsRecyclerviewAdapter;
...
//        });
    ...
    private void callSearchResults(String orderBy, int index) {
        ...
        try {
            ...
            Toast.makeText(SearchResultsActivity.this, R.string.something_went_wrong+"", Toast.LENGTH_SHORT).show();
        }
    }
