...
public class ThrillerBooksAdapter extends RecyclerView.Adapter<ThrillerBooksAdapter.ViewHolder> {

    Context context;
    private List<VolumeBooks> listdata;
    private RequestOptions options;

    public ThrillerBooksAdapter(Context context, List<VolumeBooks> listdata) {
