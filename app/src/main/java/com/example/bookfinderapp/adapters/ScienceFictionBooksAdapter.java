...
public class ScienceFictionBooksAdapter extends RecyclerView.Adapter<ScienceFictionBooksAdapter.ViewHolder> {

    Context context;
    private List<VolumeBooks> listdata;
    private RequestOptions options;

    public ScienceFictionBooksAdapter(Context context, List<VolumeBooks> listdata) {
