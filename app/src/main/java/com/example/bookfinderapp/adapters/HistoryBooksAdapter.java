...
public class HistoryBooksAdapter extends RecyclerView.Adapter<HistoryBooksAdapter.ViewHolder> {

    Context context;
    private List<VolumeBooks> listdata;
    private RequestOptions options;

    public HistoryBooksAdapter(Context context, List<VolumeBooks> listdata) {
