...
public class FantasyBooksAdapter extends RecyclerView.Adapter<FantasyBooksAdapter.ViewHolder> {

    Context context;
    private List<VolumeBooks> listdata;
    private RequestOptions options;

    public FantasyBooksAdapter(Context context, List<VolumeBooks> listdata) {
