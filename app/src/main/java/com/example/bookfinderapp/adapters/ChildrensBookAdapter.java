...
public class ChildrensBookAdapter extends RecyclerView.Adapter<ChildrensBookAdapter.ViewHolder> {

    Context context;
    private List<VolumeBooks> listdata;
    private RequestOptions options;

    public ChildrensBookAdapter(Context context, List<VolumeBooks> listdata) {
