...
public class ContemporaryBooksAdapter extends RecyclerView.Adapter<ContemporaryBooksAdapter.ViewHolder> {

    Context context;
    private List<VolumeBooks> listdata;
    private RequestOptions options;

    public ContemporaryBooksAdapter(Context context, List<VolumeBooks> listdata) {
