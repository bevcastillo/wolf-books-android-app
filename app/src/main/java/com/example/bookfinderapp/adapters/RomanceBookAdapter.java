...
public class RomanceBookAdapter extends RecyclerView.Adapter<RomanceBookAdapter.ViewHolder> {

    Context context;
    private List<VolumeBooks> listdata;
    private RequestOptions options;

    public RomanceBookAdapter(Context context, List<VolumeBooks> listdata) {
