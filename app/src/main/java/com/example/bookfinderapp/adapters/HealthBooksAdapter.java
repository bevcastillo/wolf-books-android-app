...
public class HealthBooksAdapter extends RecyclerView.Adapter<HealthBooksAdapter.ViewHolder> {

    Context context;
    private List<VolumeBooks> listdata;
    private RequestOptions options;

    public HealthBooksAdapter(Context context, List<VolumeBooks> listdata) {
