...
public class MotivationalBooksAdapter extends RecyclerView.Adapter<MotivationalBooksAdapter.ViewHolder> {

    Context context;
    private List<VolumeBooks> listdata;
    private RequestOptions options;

    public MotivationalBooksAdapter(Context context, List<VolumeBooks> listdata) {
