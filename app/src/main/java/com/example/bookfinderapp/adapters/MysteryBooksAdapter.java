...
public class MysteryBooksAdapter extends RecyclerView.Adapter<MysteryBooksAdapter.ViewHolder> {

    Context context;
    private List<VolumeBooks> listdata;
    private RequestOptions options;

    public MysteryBooksAdapter(Context context, List<VolumeBooks> listdata) {
